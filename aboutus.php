...
?>
    ...
    <div class="wide">
        ...
        <br>
        <h3 style="color: grey">Order food & beverages online from restaurants near & around you. <h3 style="color: grey">We deliver food from your neighborhood local joints, your favorite cafes, luxurious & elite restaurants in your area,</h3><h3 style="color : grey"> and also from chains like Dominos, KFC, Burger King, Pizza Hut, FreshMenu, Mc Donald's, Subway, Faasos, Cafe Coffee Day, Taco Bell, and more. Exciting bit?</h3><h3 style="color : grey"> We place no minimum order restrictions! Order in as little (or as much) as you'd like. We'll deliver it to you!</h3></h3>
    </div>
